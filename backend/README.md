...
## Project Structure
    ...
    ├── ideapros_llc_unicor_32425  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_unicor_32425`
...
2. Clone this repo and `cd ideapros_llc_unicor_32425`
